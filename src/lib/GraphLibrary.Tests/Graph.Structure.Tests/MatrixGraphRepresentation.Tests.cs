...
public class MatrixGraphRepresentationTests
{
    ...
    {
        var graph1 = new MatrixGraphRepresentation<int>(2);
        var graph2 = new MatrixGraphRepresentation<float>(2);
    ...
    public void ReadingStream_ForDirectedWeightedGraph_ValidStructure()
    {
        ...
        var graph = new MatrixGraphRepresentation<int>(ms, true);
    ...
    public void ReadingStream_ForUndirectedWeightedGraph_ValidStructure()
    {
        ...
        var graph = new MatrixGraphRepresentation<int>(ms, false);
